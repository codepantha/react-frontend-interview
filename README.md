...
```sh
  cd my-folder
  git clone https://github.com/codepantha/react-frontend-interview.git
```
...
Feel free to check the [issues page](https://github.com/codepantha/react-frontend-interview/issues).
